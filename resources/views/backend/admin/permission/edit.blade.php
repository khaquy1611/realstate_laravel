    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h6 class="card-title">Chỉnh sửa quyền người dùng</h6>

                <form class="forms-sample" action="{{ route('admin.permission.update', $permission->id) }}" method="POST">
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="Vui lòng nhập tên quyền..." value="{{ $permission->name }}" required>
                        </div>
                    </div>
